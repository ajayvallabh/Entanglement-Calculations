...
hold on
M5=smooth(S5);
h2=plot(S1,M5,'Color',myColorMap(1,:),'DisplayName','5%-\epsilon^p-PS40%','LineWidth',1.4);
%h3=plot(S1,S10,'Color',myColorMap(14,:));
%h3.Annotation.LegendInformation.IconDisplayStyle = 'off';
M10=smooth(S10);
h4=plot(S1,M10,'Color',puch1,'DisplayName','10%-\epsilon^p-PS40%','LineWidth',1.4);
%h5=plot(S1,S15,'g');
%h5.Annotation.LegendInformation.IconDisplayStyle = 'off';
M15=smooth(S15);
h6=plot(S1,M15,'Color',puch,'DisplayName','15%-\epsilon^p-PS40%','LineWidth',1.4);
% h7=plot(S1,S20,'Color',myColorMap(20,:));
% h7.Annotation.LegendInformation.IconDisplayStyle = 'off';
M20=smooth(S20);
h8=plot(S1,M20,'Color',myColorMap(22,:),'DisplayName','20%-\epsilon^p-PS40%','LineWidth',1.4);
% h9=plot(S1,S30,'Color',myColorMap(23,:));
% h9.Annotation.LegendInformation.IconDisplayStyle = 'off';
M25=smooth(S25);
h12=plot(S1,M25,'Color',myColorMap(8,:),'DisplayName','25%-\epsilon^p-PS40%','LineWidth',1.4);
M30=smooth(S30);
h10=plot(S1,M30,'Color','k','DisplayName','30%-\epsilon^p-PS40%','LineWidth',1.4);
% h11=plot(S1,S40,'m');
